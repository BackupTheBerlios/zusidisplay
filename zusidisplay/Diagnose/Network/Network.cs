...
namespace MMI.DIAGNOSE
{
	public class Network : MMI.EBuLa.Tools.INetwork
	{
		...
		public Network(ref DIAGNOSEControl control)
		{
		...
		public void Connect()
		{
			...
			try
			{
				sn.Connect(ref s, c.m_conf.Host, c.m_conf.Port, "Diagnosedisplay "+MMI.EBuLa.Tools.SuperNetwork.VERSION);
			}			   
			catch(Exception)
			{
		...
		public void ChangeState(int type, byte[] buffer)
		{
			...
			switch (type)
			{
				...
				case 56: // AFB
					break;
				case 64:// Fahrtrichtung
					c.SetFahrtrichtung(valu);
					break;
				case 70: // unknown
					break;
